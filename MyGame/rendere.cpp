...
internalVariable void drawRectangleInpix(int x0, int y0, int x1, int y1, u32 color) {
...
internalVariable float renderScale = 0.01f;
...
internalVariable void drawRectangle(float x, float y, float halfSizeX, float halfSizeY, u32 color) {
	...
	drawRectangleInpix(x0, y0, x1, y1, color);
}